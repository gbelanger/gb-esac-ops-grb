...
ao="13"
grbProposals="1340001, 1340002, 1340007, 1340011, 1340021, 1340030"
grbProposalsAndPIs="1340001 (Hurley), 1340002 (Gotz), 1340007 (Pozanenko), 1340011 (Ferrigno), 1340021 (Savchenko), 1340030 (Martin-Carrillo)"
note="Note that 1340001 (Hurley) for the IPN program uses SPI-ACS data to correlate with other instruments (these data are public and do not require any observing time); 1340002 (Gotz) and _no other proposal_ is granted access to all GRB events but _only_ for polarization studies with IBIS; and 1340021 (Savchenko) gets all IBIS Compton-mode data to study GRBs _outside_ the IBIS PCFOV (the PI is responsible for identifying the appropriate GRBs and informing ISOC). In the case of any coincident GW event, the details concerning data access are handled by the INTEGRAL Project Scientist."
