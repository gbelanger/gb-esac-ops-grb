...
ao="15"
grbProposals="1540014, 1540019, 1540027, 1540032"
grbProposalsAndPIs="1540014 (Gotz), 1540019 (Savchenko), 1540027 (Martin-Carrillo), 1540032 (Pozanenko)"
note="Note that 1540014 (Gotz) and _no other proposal_ is granted access to all GRB events but _only_ for polarization studies with IBIS; and 1540019 (Savchenko) gets all IBIS Compton-mode data to study GRBs _outside_ the IBIS PCFOV (the PI is responsible for identifying the appropriate GRBs and informing ISOC). In the case of any coincident GW or high-energy neutrino event, the details concerning data access are handled by the INTEGRAL Project Scientist."
...
dataRights="1540027 (Martin-Carrillo) is granted data rights on all instruments."
